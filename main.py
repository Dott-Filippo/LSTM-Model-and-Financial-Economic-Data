...
def fit_prophet_model(data_prophet, exogenous_data_prophet, lifecycle_data_prophet):
    ...
    model_prophet = Prophet(yearly_seasonality=True, daily_seasonality=False, changepoint_prior_scale=0.000000000000001)
...
def main():
    ...
    logo = Image.open("Delfi_9.png")  # Carica l'immagine
